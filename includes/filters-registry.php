	...
	return [
		'interet' => [
			...
			'filters' => [
				...
				'culture_histoire'  => __( 'Culture & histoire', 'travel-finder' ),
				...
				'shopping'          => __( 'Shopping', 'travel-finder' ),
		...
		'saison' => [
			...
			'order'   => 2,
			'filters' => [
				'hiver'     => __( 'Hiver', 'travel-finder' ),
				'printemps' => __( 'Printemps', 'travel-finder' ),
				'ete'       => __( 'Été', 'travel-finder' ),
		...
		'geographie' => [
			...
			'filters' => [
				...
				'mediterranee'  => __( 'Méditerranée', 'travel-finder' ),
				'europe'        => __( 'Europe', 'travel-finder' ),
				'sans_decalage' => __( 'Sans décalage horaire', 'travel-finder' ),
				'plus_loin'     => __( 'Plus loin', 'travel-finder' ),
			],
		],
	];
}
